    ...
    <footer className="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-8 border-t border-gray-300 dark:border-gray-700">
      <section className="py-8">
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="space-y-2">
            <h6 className="text-lg font-semibold text-black dark:text-red-400">
              HomeBNB
            </h6>
          </div>

          <div className="space-y-2">
            <h6 className="text-lg font-semibold text-black dark:text-red-400">Joina oss</h6>
            <p>
          ...
          <div className="space-y-2">
            <h6 className="text-lg font-semibold text-black dark:text-red-400">Börja här</h6>
            <p>
          ...
          <div className="space-y-2">
            <h6 className="text-lg font-semibold text-black dark:text-red-400">Kontakta oss</h6>
            <p>
      ...
      <section className="pt-4 border-t border-gray-300 dark:border-gray-700">
        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
          © 2024 Copyright Inc. - HomeBNB - All rights reserved
        </div>
      </section>
    </footer>
  );
